...
public class PdfUtils {
    ...
    public static void main(String[] args){
        try {
            ...
            PdfUtils.generateToFile(path, "templates/pdf/tpl.ftl",path+"static/images/pdf/", o, "D:\\xdemo2.pdf");
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
...
//        Document document = new Document(PageSize.A4, 50, 50, 60, 80);
